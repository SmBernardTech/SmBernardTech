...
❀ UX/UI Design & Accessibility<br>
✿ Full-Stack Web Development<br>
❀ REST APIs & Database Design<br>
✿ Mobile-Friendly & Responsive Design<br>
❀ AI-Assisted Development Workflows<br>
✿ System Design, UML, & Project Planning<br>
❀ Front End: JavaScript, TypeScript, Vue, Quasar, HTML, & CSS<br>
✿ Back End: Python, FastAPI, & PostgreSQL<br>
